...
1) Убедись, что доступна PostgreSQL (профиль `dev`) или используй тестовый профиль.
2) Запусти приложение (см. раздел «Конфигурация приложения (PostgreSQL)»).
3) Открой Swagger UI и проверь эндпойнты.
